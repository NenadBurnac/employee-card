...
import { EmployeeModel, EmployeeModelType } from './employee-dashboard.model';
...
export class EmployeeDashboardComponent implements OnInit {
  formValue !: FormGroup;
  employeeModelObj : EmployeeModelType = new EmployeeModel();
  employeeData !: any;
  showAdd! : boolean;
  showUpdate !: boolean;
  ...
  postEmployeeDetails(){
    this.employeeModelObj.id = undefined;
